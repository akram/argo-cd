...
func NewCommand() *cobra.Command {
	...
	command.Flags().StringVar(&shardingAlgorithm, "sharding-method", common.LegacyShardingAlgorithm, "Enables choice of sharding method. Supported sharding methods are : [legacy (default), round-robin] ")
